...
def build_replicate_map_across_days(data_root, day_start=1, day_end=7):
    """
    构建并行实验条件到各天文件路径的映射：
...
def main():
    ...
    # 每个实验条件单独出图：Rxx day1-7 + day0 baseline
    ...
    for rep_tag in sorted(replicate_map.keys()):
        ...
        save_name = f"areaRatio_{safe_tag}_day0-7.png"
